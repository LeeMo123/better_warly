...
local function MakePreparedFood(data)
    ...
    if spicename ~= nil then
        table.insert(foodassets, Asset("ANIM", "anim/warly_spices.zip"))
    ...
    local function fn()
        ...
        if spicename ~= nil then
            ...
            inst.AnimState:OverrideSymbol("swap_garnish", "warly_spices", spicename)
        ...
        if spicename ~= nil then
            inst.components.inventoryitem.atlasname = "images/inventoryimages/"..spicename.."_over.xml"
...
for k, v in pairs(require("prefabs_init/warly_spicedfoods")) do
